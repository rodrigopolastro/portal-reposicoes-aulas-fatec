...
CREATE TABLE JUSTIFICATIVAS_FALTAS (
    ...
    CONSTRAINT FK_TIPOS_FALTAS_JUSTIFICATIVAS_FALTAS
        ...
        ON DELETE RESTRICT,
    CONSTRAINT FK_USUARIOS_JUSTIFICATIVAS_FALTAS
        FOREIGN KEY (JUF_id_professor)
        REFERENCES USUARIOS (USR_id)
        ON DELETE RESTRICT
);
...
CREATE TABLE PLANOS_REPOSICOES (
    ...
    CONSTRAINT FK_JUSTIFICATIVAS_FALTAS_PLANOS_REPOSICOES
        ...
        REFERENCES JUSTIFICATIVAS_FALTAS (JUF_id)
        ON DELETE RESTRICT,
    CONSTRAINT FK_USUARIOS_PLANOS_REPOSICOES
        FOREIGN KEY (PLR_id_professor)
        REFERENCES USUARIOS (USR_id)
        ON DELETE RESTRICT
);
...
CREATE TABLE HORARIOS_DISCIPLINAS (
    ...
    CONSTRAINT UNQ_HORARIOS_DISCIPLINAS_horario_e_disciplina 
        UNIQUE (HRD_id_horario, HRD_id_disciplina),
...
CREATE TABLE HORARIOS_AUSENCIAS (
    ...
    CONSTRAINT UNQ_HORARIOS_AUSENCIAS_horario_e_justificativa 
        UNIQUE (HRA_data_falta, HRA_id_horario, HRA_id_justificativa),
...
CREATE TABLE HORARIOS_REPOSICOES (
    ...
    CONSTRAINT UNQ_HORARIOS_REPOSICOES_horario_e_reposicao 
        UNIQUE (HRR_data_reposicao, HRR_id_horario, HRR_id_reposicao),
