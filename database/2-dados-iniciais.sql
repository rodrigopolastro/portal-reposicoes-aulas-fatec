...
INSERT INTO HORARIOS_FATEC (
    ...
    (2, 'segunda', '13:00', '13:50'),
    (2, 'segunda', '13:50', '14:40'),
    (2, 'segunda', '14:50', '15:40'),
    (2, 'segunda', '15:40', '16:30'),
    (2, 'segunda', '16:40', '17:30'),
    (2, 'segunda', '17:30', '18:20'), 
    (2, 'segunda', '18:10', '19:00'),
    (2, 'segunda', '19:00', '19:50'),
    (2, 'segunda', '19:50', '20:40'),
    (2, 'segunda', '20:50', '21:40'),
    (2, 'segunda', '21:40', '22:30'), 
    (3, 'terça', '13:00', '13:50'),
    (3, 'terça', '13:50', '14:40'),
    (3, 'terça', '14:50', '15:40'),
    (3, 'terça', '15:40', '16:30'),
    ...
    (3, 'terça', '20:50', '21:40'),
    (3, 'terça', '21:40', '22:30'),
    (4, 'quarta', '13:00', '13:50'),
    (4, 'quarta', '13:50', '14:40'),
    (4, 'quarta', '14:50', '15:40'),
    (4, 'quarta', '15:40', '16:30'),
    (4, 'quarta', '16:40', '17:30'),
    (4, 'quarta', '17:30', '18:20'),
    (4, 'quarta', '18:10', '19:00'),
    (4, 'quarta', '19:00', '19:50'),
    (4, 'quarta', '19:50', '20:40'),
    (4, 'quarta', '20:50', '21:40'),
    (4, 'quarta', '21:40', '22:30'),
    (5, 'quinta', '13:00', '13:50'),
    (5, 'quinta', '13:50', '14:40'),
    (5, 'quinta', '14:50', '15:40'),
    (5, 'quinta', '15:40', '16:30'),
    (5, 'quinta', '16:40', '17:30'),
    (5, 'quinta', '17:30', '18:20'),
    (5, 'quinta', '18:10', '19:00'),
    (5, 'quinta', '19:00', '19:50'),
    (5, 'quinta', '19:50', '20:40'),
    (5, 'quinta', '20:50', '21:40'),
    (5, 'quinta', '21:40', '22:30'),
    (6, 'sexta', '13:00', '13:50'),
    (6, 'sexta', '13:50', '14:40'),
    (6, 'sexta', '14:50', '15:40'),
    (6, 'sexta', '15:40', '16:30'),
    ...
    (6, 'sexta', '20:50', '21:40'),
    (6, 'sexta', '21:40', '22:30'),
    (7, 'sábado', '07:40', '08:30'),
    (7, 'sábado', '08:30', '09:20'),
    (7, 'sábado', '09:20', '10:10'),
    (7, 'sábado', '10:10', '11:00'),
    (7, 'sábado', '11:10', '12:00'),
    (7, 'sábado', '12:00', '12:50'),
    (7, 'sábado', '13:00', '13:50'),
    (7, 'sábado', '13:50', '14:40'),
    (7, 'sábado', '14:50', '15:40'),
    (7, 'sábado', '15:40', '16:30'),
    (7, 'sábado', '16:40', '17:30'),
    (7, 'sábado', '17:30', '18:20');
