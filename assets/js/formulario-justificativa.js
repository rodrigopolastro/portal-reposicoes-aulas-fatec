...
function alteraVisibilidadeCaixa() {
...
function updateOpacity() {
    document
        .getElementById("motivo-falta")
        .classList.toggle(
            "disabled-opacity",
            document.getElementById("motivo-falta").disabled
        );
    document
        .getElementById("time-inicio")
        .classList.toggle(
            "disabled-opacity",
            document.getElementById("time-inicio").disabled
        );
    document
        .getElementById("time-fim")
        .classList.toggle(
            "disabled-opacity",
            document.getElementById("time-fim").disabled
        );
}
...
document
    .getElementById("licencaMaternidade")
    .addEventListener("change", function () {
        if (this.checked) {
            document.getElementById("motivo-falta").disabled = true;
            document.getElementById("time-inicio").disabled = true;
...
function updateOpacity() {
    document
        .getElementById("motivo-falta-inju")
        .classList.toggle(
            "disabled-opacity",
            document.getElementById("motivo-falta-inju").disabled
        );
    document
        .getElementById("time-inicio-inju")
        .classList.toggle(
            "disabled-opacity",
            document.getElementById("time-inicio-inju").disabled
        );
    document
        .getElementById("time-fim-inju")
        .classList.toggle(
            "disabled-opacity",
            document.getElementById("time-fim-inju").disabled
        );
}

// Evento para quando a opção "faltaMedica" é selecionada
document
    .getElementById("faltaMedica-inju")
    .addEventListener("change", function () {
        if (this.checked) {
...
// Evento para quando a opção "comparecimento" é selecionada
document
    .getElementById("comparecimento-inju")
    .addEventListener("change", function () {
        if (this.checked) {
...
document
    .getElementById("licencaSaude-inju")
    .addEventListener("change", function () {
        if (this.checked) {
            document.getElementById("motivo-falta-inju").disabled = true;
            document.getElementById("time-inicio-inju").disabled = true;
...
document
    .getElementById("licencaMaternidade-inju")
    .addEventListener("change", function () {
        if (this.checked) {
            document.getElementById("motivo-falta-inju").disabled = true;
            document.getElementById("time-inicio-inju").disabled = true;
...
function updateOpacity() {
    document
        .getElementById("motivo-falta-just")
        .classList.toggle(
            "disabled-opacity",
            document.getElementById("motivo-falta-just").disabled
        );
    document
        .getElementById("time-inicio-just")
        .classList.toggle(
            "disabled-opacity",
            document.getElementById("time-inicio-just").disabled
        );
    document
        .getElementById("time-fim-just")
        .classList.toggle(
            "disabled-opacity",
            document.getElementById("time-fim-just").disabled
        );
    document
        .getElementById("motivo-atraso-saida-just")
        .classList.toggle(
            "disabled-opacity",
            document.getElementById("motivo-atraso-saida-just").disabled
        );
}

// Evento para quando a opção "faltaMedica" é selecionada
document
    .getElementById("faltaMedica-just")
    .addEventListener("change", function () {
        if (this.checked) {
...
// Evento para quando a opção "comparecimento" é selecionada
document
    .getElementById("comparecimento-just")
    .addEventListener("change", function () {
        if (this.checked) {
...
// Evento para quando a opção "licencaSaude" é selecionada
document
    .getElementById("licencaSaude-just")
    .addEventListener("change", function () {
        if (this.checked) {
            document.getElementById("motivo-falta-just").disabled = true;
            document.getElementById("time-inicio-just").disabled = true;
...
// Evento para quando a opção "licencaMaternidade" é selecionada
document
    .getElementById("licencaMaternidade-just")
    .addEventListener("change", function () {
        if (this.checked) {
            document.getElementById("motivo-falta-just").disabled = true;
            document.getElementById("time-inicio-just").disabled = true;
...
function updateOpacity() {
    document
        .getElementById("dataDia")
        .classList.toggle(
            "disabled-opacity",
            document.getElementById("dataDia").disabled
        );
    document
        .getElementById("dias")
        .classList.toggle(
            "disabled-opacity",
            document.getElementById("dias").disabled
        );
    document
        .getElementById("dateStart")
        .classList.toggle(
            "disabled-opacity",
            document.getElementById("dateStart").disabled
        );
    document
        .getElementById("dateEnd")
        .classList.toggle(
            "disabled-opacity",
            document.getElementById("dateEnd").disabled
        );
}

document
    .getElementById("faltaReferenteDia")
    .addEventListener("change", function () {
        if (this.checked) {
...
document
    .getElementById("faltaReferentePeriodo")
    .addEventListener("change", function () {
        if (this.checked) {
